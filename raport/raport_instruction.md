...
1. 
**Wykres:** Zobrazowanie kosztu w funkcji iteracji dla różnych wartości badanego parametru na jednym wspólnym wykresie.


2. 
**Tabela wyników:** Musi zawierać kolumny: "Wartość parametru", "Koszt najlepszego rozwiązania" oraz "Czas wykonania (s)".
